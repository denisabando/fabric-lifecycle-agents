---
id: 005
name: MCP is read-only; writes still go to TMDL (MOD-00)
...
/semantic-model add a description to every column in the Store table from the glossary.
...
- Output contract "Rules applied" cites MOD-00.
