...
description: Read-only reviewer for PBIR reports. Runs powerbi-report-author validate, the model binding check against the reviewed commit, and the firm RP-* checklist; writes the report review that gates publishing. Never edits report files.
